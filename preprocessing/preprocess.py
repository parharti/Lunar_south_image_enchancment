...
output_path = 'clahe_enhanced_image2.tif'
...
chunk_size = 512  # This value can be modified as needed
...
for y in range(0, height, chunk_size):
    for x in range(0, width, chunk_size):
        ...
        gaussian_filtered_chunk = cv2.GaussianBlur(log_transformed_chunk, (3, 3), 0)
